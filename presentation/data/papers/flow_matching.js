...
const flowMatchingDeepDive = {
  ...
  links: {
    ...
    pdf: "../presentation/assets/papers/flow_matching/flow_matching.pdf",
    localPdf: "assets/papers/flow_matching/flow_matching.pdf",
    localSourceTex: "assets/papers/flow_matching/source/extracted/fm_arxiv_v2.tex"
  },
  ...
  benchmarks: [
    {
      ...
      rows: [
        ...
        ["NFE = 20", "0.008224", "0.005230 ★", "大幅超越 36.4% (由于轨道是直的，20步 Euler 积分几无一阶数值误差)"],
        ["NFE = 5 (极限少步)", "0.022651", "0.009841 ★", "巨幅领先 56.6% (弯曲 DDIM 此时已脱落，直线 FM-OT 依然精准聚拢)"],
        ["NFE = 1 (无蒸馏单步)", "0.288564", "0.198544 ★", "巨幅领先 31.2% (单步直接粗暴外推，直线速度场的几何偏偏折最小)"]
      ],
      note: "核心消融洞察：Flow Matching-OT 最大的物理优势体现在“少步无偏”上。在 NFE=20 的横向评测大考中，其 Chamfer 距离（0.005230）竟然直接打平了 DDIM 在 NFE=100 时的极限。在极少步 NFE=5 大考下，其 CD（0.009841）更是比未蒸馏的 DDIM（0.022651）好了接近 2.3 倍。这以绝对硬核的数据证明了“拉直物理路轨”在大步长数值微积分计算中对压制累积截断误差的无上神力！"
    }
  ],
